...
export default async function Home(props) {
  ...
  const horaAsignadoSeries =
    session && dbReady ? await getHoraAsignadoSeries(start, end) : [];
    ...
    <div className="py-6">
      <main className="container-responsive px-4 sm:px-6">
        ...
        <form
          ...
          className="mt-8 flex flex-col sm:flex-row flex-wrap sm:items-end items-center justify-center gap-3"
        >
        ...
        <div className="mt-10">
          ...
          {!dbReady ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold">Actividad por asesor</h3>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold">
                    Horas de asignación (08–19)
                  </h3>
                  <HeatmapLoader
                    series={horaAsignadoSeries}
                    start={start}
                    end={end}
                  />
                </div>
        ...
        {!isSingleDay ? (
          <div className="mt-10">
            <h2 className="text-xl font-semibold">Evolución diaria por tipo</h2>
            {!dbReady ? (
              <p className="mt-2 opacity-80">
                Configura DATABASE_URL para consultar la base de datos.
              </p>
