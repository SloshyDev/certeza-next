...
export default function DescargarCanceladasButton({ filters }) {
  ...
  return (
    <button
      ...
      className="px-4 py-2 bg-amber-500 text-white rounded-md hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors font-medium shadow-sm"
    >
      {isGenerating ? (
        <>
