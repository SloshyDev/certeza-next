...
const EditableSelect = ({
  ...
  return (
    <select
      ...
      disabled={loading}
      className={`bg-transparent border-none p-0 text-xs font-medium focus:ring-0 cursor-pointer ${getStatusColor(
        currentValue
...
const EditableText = ({
  ...
  return (
    <input
      ...
      onBlur={handleBlur}
      disabled={loading}
      className={`bg-transparent border-none p-0 text-foreground focus:ring-1 focus:ring-accent rounded px-1 ${
        loading ? "opacity-50" : ""
      } ${className}`}
    />
  );
...
const EditableDate = ({
    ...
    return (
      <span>
        {value ? (
          ...
          <span className="text-muted-foreground text-red-500">Sin fecha</span>
        )}
      </span>
    );
  }
  ...
  return (
    <input
      ...
      onBlur={handleBlur}
      disabled={loading}
      className={`bg-transparent border-none p-0 text-xs text-foreground focus:ring-1 focus:ring-accent rounded px-1 w-full ${
        loading ? "opacity-50" : ""
      } ${className}`}
    />
  );
...
const EditableTextArea = ({
  ...
  return (
    <textarea
      ...
      className={`bg-transparent border border-transparent hover:border-border focus:border-accent rounded p-1 text-sm w-full min-w-[200px] resize-y ${
        loading ? "opacity-50" : ""
      } ${className}`}
    />
  );
...
const EditableAsesorSelect = ({
  ...
  return (
    <select
      ...
      onChange={handleChange}
      disabled={loading}
      className={`bg-transparent border-none p-0 text-xs font-medium focus:ring-0 cursor-pointer text-foreground ${
        loading ? "opacity-50" : ""
      } ${className}`}
    >
      <option value="" disabled>
